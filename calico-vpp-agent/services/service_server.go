...
type LocalService struct {
	...
	ServiceID      string
	// DSREntries holds SRv6-native / NAT-less (DSR) ClusterIP entries for this
	// service. When non-empty, the corresponding ClusterIPs are NOT programmed
	// as cnat translations; they are steered/delivered over SRv6 instead.
